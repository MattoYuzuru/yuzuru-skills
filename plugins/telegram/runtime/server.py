...
TOOLS = [
    ...
    tool("download_file", "Download one bounded Telegram file into the isolated TDLib cache.", schema({"file_id": S, "max_bytes": I}, ["file_id"]), read=True),
    ...
    tool("send_file", "Send one bounded local file and optional caption, then wait for final confirmation.", schema({"conversation_id": S, "thread_id": S, "reply_to_message_id": S, "path": S, "caption": S, "silent": B, "max_bytes": I}, ["conversation_id", "path"])),
